...
static void mutt_query_pipe_attachment(char *command, FILE *fp, BODY *body, int filter)
{
...
static void mutt_update_attach_index(BODY *cur, ATTACHPTR ***idxp, short *idxlen,
