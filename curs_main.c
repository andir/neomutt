...
static const struct mapping_t IndexHelp[] = {{N_("Quit"), OP_QUIT},
                                             {N_("Del"), OP_DELETE},
...
#ifdef USE_NNTP
struct mapping_t IndexNewsHelp[] = {{N_("Quit"), OP_QUIT},
                                    {N_("Del"), OP_DELETE},
                                    {N_("Undel"), OP_UNDELETE},
                                    {N_("Save"), OP_SAVE},
                                    {N_("Post"), OP_POST},
	 ...
	 */
      ...
      case OP_MARK_MSG:
        ...
        if (CURHDR->env->message_id)
        {
          ...
          if (!mutt_get_field(_("Enter macro stroke: "), buf, sizeof(buf), MUTT_CLEAR) &&
              buf[0])
          {
