...
const struct binding_t OpGeneric[] =
    {/* map: generic */
     /*
  ** <para> The <emphasis>generic</emphasis> menu is not a real menu, but
  ** specifies common functions (such as movement) available in all menus except
  ** for <emphasis>pager</emphasis> and <emphasis>editor</emphasis>. Changing
  ** settings for this menu will affect the default bindings for all menus
  ** (except as noted). </para>
  */
     // clang-format off
