...
const struct binding_t OpPager[] =
    {/* map: pager */
     {"break-thread", OP_MAIN_BREAK_THREAD, "#"},
     {"create-alias", OP_CREATE_ALIAS, "a"},
     {"bounce-message", OP_BOUNCE_MESSAGE, "b"},
...
const struct binding_t OpCompose[] =
    {/* map: compose */
...
/* The file browser */
const struct binding_t OpBrowser[] =
    {/* map: browser */
...
const struct binding_t OpEditor[] =
    {/* map: editor */
