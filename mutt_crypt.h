...
#define KEYFLAG_ABILITIES                                                      \
  (KEYFLAG_CANSIGN | KEYFLAG_CANENCRYPT | KEYFLAG_PREFER_ENCRYPTION | KEYFLAG_PREFER_SIGNING)
...
/* Ask for a PGP key. */
pgp_key_t crypt_pgp_ask_for_key(char *tag, char *whatfor, short abilities, pgp_ring_t keyring);
